...
#
# Document: trident-training-manual
...
project = u'Trident Training Manual'
...
htmlhelp_basename = 'trident-training-manualdoc'
...
latex_documents = [
  (master_doc,
   'trident-training-manual.tex',
   u'Trident Training Manual Documentation',
   u'Dave Dittrich',
   'manual'),
]
...
man_pages = [
    (master_doc,
     'trident-training-manual',
     u'Trident Training Manual',
     [u'Dave Dittrich'],
     1)
]
